# -*- coding: utf-8 -*-
# Generated by Django 1.11.26 on 2019-11-25 05:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('projects', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='awards.Project')),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='awards.User'),
        ),
        migrations.AddField(
            model_name='project',
            name='user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='awards.User'),
        ),
    ]
